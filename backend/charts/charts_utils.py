...
def draw_elements_percentages(
    ...
    out = '<g transform="translate(-30,30)">'
    out += f'<text y="0" style="fill:#FF5555; font-size: 10px;">{fire_label}  {str(fire_percentage)}%</text>'
    out += f'<text y="12" style="fill:#50FA7B; font-size: 10px;">{earth_label} {str(earth_percentage)}%</text>'
    out += f'<text y="24" style="fill:#F8F8F2; font-size: 10px;">{air_label}   {str(air_percentage)}%</text>'
    out += f'<text y="36" style="fill:#8BE9FD; font-size: 10px;">{water_label} {str(water_percentage)}%</text>'
    out += "</g>"
