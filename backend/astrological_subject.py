...
# from src.fetch_geonames import FetchGeonames
from backend.kr_types import (
    KerykeionException,
    ZodiacType,
...
DEFAULT_GEONAMES_USERNAME = "oraculo"
...
class AstrologicalSubject:
    ...
    def __init__(
        ...
        swe.set_ephe_path(settings.EPHEMERIS_PATH.as_posix())
