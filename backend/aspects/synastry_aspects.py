...
from backend import AstrologicalSubject
...
from backend.aspects.aspects_utils import planet_id_decoder, get_aspect_from_two_points, get_active_points_list
...
if __name__ == "__main__":
    from backend.utilities import setup_logging
